...
public static final ERCloudFilesAttachmentPath path = new ERCloudFilesAttachmentPath(null);

public static class ERCloudFilesAttachmentPath extends ERXKey<er.attachment.model.ERCloudFilesAttachment> {
public ERCloudFilesAttachmentPath(String key) { 
 super(key);
}
...
public ERXKey<String> cfPath() {
 return this.append(CF_PATH);
}
