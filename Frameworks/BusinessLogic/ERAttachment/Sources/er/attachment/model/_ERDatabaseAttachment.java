...
public static final ERDatabaseAttachmentPath path = new ERDatabaseAttachmentPath(null);

public static class ERDatabaseAttachmentPath extends ERXKey<er.attachment.model.ERDatabaseAttachment> {
public ERDatabaseAttachmentPath(String key) { 
 super(key);
}
...
public ERXKey<NSData> smallData() {
 return this.append(SMALL_DATA);
}
...
public er.attachment.model.ERAttachmentData.ERAttachmentDataPath attachmentData() { 
 return new er.attachment.model.ERAttachmentData.ERAttachmentDataPath(this.append(ATTACHMENT_DATA).key()); 
}
