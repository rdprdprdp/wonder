...
public static final ERFileAttachmentPath path = new ERFileAttachmentPath(null);

public static class ERFileAttachmentPath extends ERXKey<er.attachment.model.ERFileAttachment> {
public ERFileAttachmentPath(String key) { 
 super(key);
}
...
public ERXKey<String> filesystemPath() {
 return this.append(FILESYSTEM_PATH);
}
