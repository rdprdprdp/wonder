...
public static final ERS3AttachmentPath path = new ERS3AttachmentPath(null);

public static class ERS3AttachmentPath extends ERXKey<er.attachment.model.ERS3Attachment> {
public ERS3AttachmentPath(String key) { 
 super(key);
}
...
public ERXKey<String> s3Path() {
 return this.append(S3_PATH);
}
